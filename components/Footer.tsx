...
export default function Footer() {
  return (
    <footer className="relative z-10 border-t border-[rgba(255,255,255,0.055)] bg-[var(--navy-deep)] backdrop-blur-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            <Link href="/" className="inline-block mb-4">
              ...
              <span className="ml-1.5 text-xs font-mono text-[var(--gold-bright)] tracking-widest uppercase">
                Ltd
              </span>
            </Link>
          ...
          <div className="grid grid-cols-2 gap-8">
            <div>
              <h3 className="text-xs font-mono text-[var(--cream)] uppercase tracking-widest mb-4">
                Practices
              </h3>
              <ul className="space-y-2.5">
                {practices.map((link) => (
                  <li key={link.name}>
                    <Link
                      href={link.href}
                      className="text-sm text-[var(--cream-muted)] hover:text-[var(--gold)] transition-colors"
                    >
                      {link.name}
                    </Link>
                  </li>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a
                  ...
                  className="flex items-center gap-2 text-sm text-[--text-muted] hover:text-white transition-colors"
                >
                  <MessageCircle size={13} className="text-[var(--gold)] shrink-0" />
                  +254 746 089 499
                </a>
              </li>
        ...
        {/* Bottom bar */}
        <div className="pt-8 border-t border-[rgba(255,255,255,0.055)] flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-[rgba(237,232,223,0.2)] text-sm">
